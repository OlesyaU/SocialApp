...
* На экране комментария реализовано отображение даты в коротоком формате(требование макета)б можно поставить\ убрать лайк комментарию
...
** Олеся Украинская
[Ссылка](https://github.com/OlesyaU?tab=repositories)
[Ссылка](https://t.me/@OlesyaUkrainskaya)
