...
func avatars() -> [UIImage] {
    var avatarsForPost: [UIImage] = []
    avatarsForPost.append(UIImage(named: "Avatar1")!)
    avatarsForPost.append(UIImage(named: "Avatar2")!)
    avatarsForPost.append(UIImage(named: "Avatar3")!)
    avatarsForPost.append(UIImage(named: "Avatar4")!)
    avatarsForPost.append(UIImage(named: "Avatar5")!)
